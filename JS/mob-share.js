...
! function(a, b) {
    ...
    function g(a, b, c, d) {
        var e = J.Array(a) ? a : [a],
            f = b.split(" ");
        k(e, function(a, b) { k(f, function(a, e) { b.addEventListener ? b.addEventListener(e, c, d) : b.attachEvent && b.attachEvent("on" + e, c) }) })
    }
    ...
    function h(b, c) {
        for (var d = J.Array(b) ? b : [b], e = Object.prototype.hasOwnProperty, f = 0, g = d.length; g > f; f++) {
            var h, i, b = d[f];
            if (J.Object(c))
                for (h in c) e.call(c, h) && (i = c[h], b.style[h] = "function" == typeof i ? i.call(b, h) : i);
            else {
    ...
    function j(a, b) {
        var c = J.Array(a) ? a : [a];
        k(c, function(a, c) { i(c, b) || (c.className += " " + b) })
    }
    ...
    function o(a, c, d, e) {
        ...
        var f = b.createElement("iframe"),
            g = !1;
        f.onload = function() {!g && d && d(!0, "success"), g = !0, f.parentNode.removeChild(f) }, setTimeout(function() {!g && d && d(!1, "timeout") }, e), f.src = a + "?" + p(c), f.style.display = "none", b.body.appendChild(f)
    }

    function p(a) {
        var b = [];
        if (a.constructor === Array)
            for (var c = 0; c < a.length; c++) b.push(a[c].name + "=" + encodeURIComponent(a[c].value));
        else
    ...
    function s(a, b) { a.attachEvent ? a.attachEvent("onload", b) : setTimeout(function() { t(a, b) }, 0) }

    function t(b, c) {
        if (!c.isCalled) {
            var d = !1;
            if (/webkit/i.test(a.navigator.userAgent)) b.sheet && (d = !0);
            else if (b.sheet) try { b.sheet.cssRules && (d = !0) } catch (e) { 1e3 === e.code && (d = !0) }
            d ? setTimeout(function() { c() }, 1) : setTimeout(function() { t(b, c) }, 1)
        }
    }
    ...
    function y(b, c, d) { c = c || "debug", c = "mob-share-" + c, (E.debug && !d || G) && a.console && a.console.log(c.toUpperCase() + ": " + b) }
    ...
    function B(c, d, e, g) {
        y("sending analytics..", null, !0), c = c || "", d = d || {};
        var h = { appkey: E.appkey, requrl: d.url || a.location.href, referer: b.referrer };
        if (!h.appkey) throw "not defined appkey";
        var i = { m: D.encode(m(f(h, d))) };
        y("analytics url: " + F + c, null, !0), y("analytics base64 paramters: " + i.m, null, !0), y("analytics clear paramters: " + D.decode(i.m), null, !0), o(F + c, i, function() { y("send analytics success", null, !0), e && e() }, g)
    }

    function C() {
        var c = { url: "", title: "", description: "", reason: "", pic: "" };
    ...
    var D, E = {
            ...
            platforms: {
                weibo: {
                    ...
                    handler: function(a) {
                        return { title: a.title + "  " + a.description, url: a.url, pic: a.pic }
                    }
                },
                qzone: {
                    id: 6,
                    ...
                    handler: function(a) {
                        return { summary: a.description, desc: a.reason ? a.reason : a.description, title: a.title, url: a.url, pics: a.pic, otype: "share" }
                    }
                },
                tencentweibo: {
                    id: 2,
                    ...
                    handler: function(a) {
                        return { c: "share", a: "index", title: a.title + "  " + a.description, site: a.url, url: a.url, pic: a.pic }
                    }
                },
                qq: {
                    id: 24,
                    ...
                    handler: function(a) {
                        return { desc: a.title + "  " + a.description, summary: a.description, title: a.title, url: a.url, pics: a.pic }
                    }
                },
                renren: {
                    id: 7,
                    ...
                    handler: function(a) {
                        return { description: a.description, title: a.title, resourceUrl: a.url, srcUrl: a.url, pic: a.pic }
                    }
                },
                kaixin: {
                    id: 8,
                    ...
                    handler: function(a) {
                        return { content: a.title + "  " + a.description, url: a.url, style: 11, pic: a.pic }
                    }
                },
                douban: {
                    id: 5,
                    ...
                    handler: function(a) {
                        return { href: a.url, text: a.description, name: a.title, title: a.title, image: a.pic }
                    }
                },
                facebook: {
                    id: 10,
                ...
                twitter: {
                    ...
                    handler: function(a) {
                        return { text: a.title + "  " + a.description, url: a.url }
                    }
                },
                tieba: {
                    id: 49,
                    ...
                    handler: function(a) {
                        return { desc: a.description, title: a.title, url: a.url, pic: a.pic }
                    }
                },
                weixin: { id: 22, construct: "Weixin" },
                pocket: {
                    id: 26,
                    api: "https://getpocket.com/edit",
                    handler: function(a) {
                        return { title: a.title + "  " + a.description, url: a.url }
                    }
                },
                evernote: {
                    id: 12,
                ...
                google: {
                    ...
                    handler: function(a) {
                        return { t: a.title + "  " + a.description, url: a.url }
                    }
                },
                youdao: {
                    id: 27,
                    ...
                    handler: function(a) {
                        return { title: a.title, summary: a.description, url: a.url, product: "ShareSDK" }
                    }
                },
                mingdao: {
                    id: 41,
                ...
                pinterest: {
                    ...
                    handler: function(a) {
                        return { title: a.title + "  " + a.description, url: a.url, media: a.pic, alt: "" }
                    }
                },
                tumblr: {
                    id: 17,
                    ...
                    handler: function(a) {
                        return { title: a.title + "  " + a.description, url: a.url, shareSource: "legacy", canonicalUrl: "" }
                    }
                },
                instapaper: {
                    id: 25,
                    ...
                    handler: function(a) {
                        return { title: a.title, url: a.url, description: a.description }
                    }
                },
                linkedin: {
                    id: 16,
                    ...
                    handler: function(a) {
                        return { title: a.title, url: a.url, summary: a.description, armin: "armin", ro: "true", mini: "true", source: "" }
                    }
                },
                pengyou: {
                    id: 9,
                    api: "http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey",
                    handler: function(a) {
                        return { to: "pengyou", url: a.url, desc: a.reason ? a.reason : a.description }
                    }
                }
            },
            appkey: null,
                        ...
                        for (var j = d.charAt(h), k = 0, l = a.length; l > k; ++k)
                            if (j == a[k]) {
                                var m = b(k),
                                    n = m.length;
                                if (6 - n > 0)
                                    for (var o = 6 - n; o > 0; --o) m.unshift(0);
                                g = g.concat(m);
                                break
                            }
                    f > 0 && (g = g.slice(0, g.length - f));
                    for (var p = [], q = [], h = 0, i = g.length; i > h;)
                        if (0 == g[h]) p = p.concat(c(g.slice(h, h + 8))), h += 8;
                        else {
    ...
    I = function() {
        ...
        function b(b) {
            for (var c = [], d = 0; d < b.length; d++)
                for (var e = b.charCodeAt(d), f = a(e), g = 0; g < f.length; g++) c.push(f[g]);
            return c
        }

        function c(a, c) { this.typeNumber = -1, this.errorCorrectLevel = c, this.modules = null, this.moduleCount = 0, this.dataCache = null, this.rsBlocks = null, this.totalDataCount = -1, this.data = a, this.utf8bytes = b(a), this.make() }
        ...
        function e() { this.buffer = new Array, this.length = 0 }
        var f = [],
            g = function(a) {
                function b(a, b) {
                    var c = Object.prototype.hasOwnProperty;
                ...
                "string" == typeof a && (a = { text: a }), this.options = b({ text: "", render: "", width: 256, height: 256, correctLevel: 3, background: "#ffffff", foreground: "#000000" }, a);
                for (var d = null, e = 0, g = f.length; g > e; e++)
                    if (f[e].text == this.options.text && f[e].text.correctLevel == this.options.correctLevel) {
                        d = f[e].obj;
                        break
                    }
                if (e == g && (d = new c(this.options.text, this.options.correctLevel), f.push({ text: this.options.text, correctLevel: this.options.correctLevel, obj: d })), this.options.render) switch (this.options.render) {
                    case "canvas":
        ...
        g.prototype.createDefault = function(a) {
            ...
            for (var b, c, d, e, f = a.getModuleCount(), g = this.options.height / this.options.width, h = '<svg xmlns="http://www.w3.org/2000/svg" width="' + this.options.width + 'px" height="' + this.options.height + 'px" viewbox="0 0 ' + 10 * f + " " + 10 * f * g + '">', i = "<path ", j = ' style="stroke-width:0.5;stroke:' + this.options.foreground + ";fill:" + this.options.foreground + ';"></path>', k = ' style="stroke-width:0.5;stroke:' + this.options.background + ";fill:" + this.options.background + ';"></path>', l = 0; f > l; l++)
                for (var m = 0; f > m; m++) b = 10 * m, d = 10 * l * g, c = 10 * (m + 1), e = 10 * (l + 1) * g, h += i + 'd="M ' + b + "," + d + " L " + c + "," + d + " L " + c + "," + e + " L " + b + "," + e + ' Z"', h += a.modules[l][m] ? j : k;
            h += "</svg>";
            ...
            createBytes: function(a) {
                for (var b = 0, c = 0, e = 0, f = this.rsBlock.length / 3, g = new Array, h = 0; f > h; h++)
                    for (var i = this.rsBlock[3 * h + 0], k = this.rsBlock[3 * h + 1], l = this.rsBlock[3 * h + 2], m = 0; i > m; m++) g.push([l, k]);
                ...
                for (var w = new Array(this.totalDataCount), x = 0, h = 0; c > h; h++)
                    for (var p = 0; p < g.length; p++) h < n[p].length && (w[x++] = n[p][h]);
                for (var h = 0; e > h; h++)
                    for (var p = 0; p < g.length; p++) h < o[p].length && (w[x++] = o[p][h]);
                return w
            },
        ...
        for (var h = [1, 0, 3, 2], i = { PATTERN000: 0, PATTERN001: 1, PATTERN010: 2, PATTERN011: 3, PATTERN100: 4, PATTERN101: 5, PATTERN110: 6, PATTERN111: 7 }, j = {
        ...
        return d.prototype = {
            ...
            multiply: function(a) {
                for (var b = new Array(this.getLength() + a.getLength() - 1), c = 0; c < this.getLength(); c++)
                    for (var e = 0; e < a.getLength(); e++) b[c + e] ^= k.gexp(k.glog(this.get(c)) + k.glog(a.get(e)));
                return new d(b, 0)
            },
            mod: function(a) {
    ...
    for (var J = { types: ["Array", "Boolean", "Date", "Number", "Object", "RegExp", "String", "Window", "HTMLDocument"] }, K = 0, L = J.types.length; L > K; K++) J[J.types[K]] = function(a) {
        return function(b) {
    ...
    M.config = function(a) {
        var b = E.appkey;
        E = f(E, a || {}), "appkey" in a && a.appkey !== b && A()
        ...
        return b.addEventListener ? (b.addEventListener("DOMContentLoaded", c, !1), b.addEventListener("readystatechange", c, !1), a.addEventListener("load", c, !1)) : b.attachEvent && (b.attachEvent("onreadystatechange", c), a.attachEvent("onload", c)),
            function(a) { e ? a.call(b) : d.push(a) }
    }(), M.ready(function() {
        y("init");
        var a = d("#-mob-share")[0];
        if (a && a.src) {
            var b = n(a.src);
            b.appkey && !E.appkey && M.config({ appkey: b.appkey });
            var c = a.src.split("?")[0].replace(/\/[^\/]+\.[^\/]+$/, "");
            M.config({ staticDir: c })
        }
    });
    var N = {};
    N.Normal = function(a) {
    ...
    }, N.Weixin = function() { this._platform = "weixin" }, N.Weixin.prototype.send = function() {
        var c = C();
        if (E.params.url && (c.url = E.params.url), r()) {
            ...
            var j = function() { O([d, i], { opacity: 0 }, 300, function() { d.parentNode.removeChild(d), i.parentNode.removeChild(i) }) };
            g(i, "click", j), g(d, "click", j), d.appendChild(e), d.appendChild(f), h([d, i], { opacity: 0 });
            var k = b.getElementsByTagName("body")[0];
            k.appendChild(d), k.appendChild(i), O(d, { opacity: 1 }, 300), O(i, { opacity: .7 }, 300)
        } else {
            var d = b.createElement("div");
            ...
            var i = b.createElement("div");
            i.className = "-mob-share-weixin-qrcode-bg";
            var o, p = new I({ text: c.url, width: 250, height: 250 });
            ...
            var j = function() { O([d, i], { opacity: 0 }, 300, function() { d.parentNode.removeChild(d), i.parentNode.removeChild(i) }) };
            g(m, "click", j), d.appendChild(m), d.appendChild(n), d.appendChild(o), h([d, i], { opacity: 0 });
            var k = b.getElementsByTagName("body")[0];
            k.appendChild(d), k.appendChild(i), O(d, { opacity: 1 }, 300), O(i, { opacity: .7 }, 300)
        }
        "function" == typeof E.callback && E.callback(this._platform, { url: c.url || "", title: c.title || "", reason: c.reason || c.description, description: c.description || "", pic: c.pic || "" }), B("/share", { snsplat: E.platforms[this._platform].id, reason: c.reason || c.description, requrl: c.url, title: c.title || c.url, content: "" })
    };
    var O = function() {
            ...
            j = 1, l = "lxjwlt" + (Math.random() + "").replace(/\D/g, ""), d = [], i = {}, a = {
                ...
                var m = function(b, f, i, j) {
                    ...
                    o += 1, r = function() { "function" == typeof j && j(), o -= 1, 0 === o && g(b) };
                    for (n in f) {
                        ...
                        } else m !== k && d.push({ elem: b, propName: n, beginVal: k, changeVal: m - k, duration: i || 0 === i ? i : 400, type: "swing", unit: p, over: r })
                    }
                    e(d, a)
                };
                b = J.Array(b) ? b : [b];
                var n = 0;
                k(b, function() { m(this, f, i, function() { n++, n === b.length && "function" == typeof j && j() }, l) })
            };
            var m = function(a, c, d, e, g) {
                var h = function() { b.call(window, a, c, d, e, g) };
                f(a, h)
            };
            return f = function(a, b) {
                ...
                if (c) {
                    ...
                    for (; c.length;)
                        if (b = c.shift(), "function" == typeof b) {
                            b(), c.unshift(d);
                            break
                        }
                }
        ...
        P = function() {
            function c(c, f, i) {
                ...
                function k() { x > 0 ? x = 0 : -o > x && (x = -o), t = 200, O(f, A(p, x + "px"), t, !1, !0) }
                ...
                g(f, "mousedown touchstart", function(a) {
                    ...
                    if (u) {
                        5 < (new Date).getTime() - z.getTime() && (l ? clearTimeout(m) : (l = b.createElement("div"), h(l, { display: "none" }), l.unselectable = "on", l.onselectstart = function() {
                            return !1
                        }, b.body.appendChild(l)), h(l, { display: "block", width: c.clientWidth + "px", height: c.clientHeight + "px", position: "fixed", opacity: .5, top: v(c).top + "px", left: v(c).left + "px", zIndex: 9999999999 }));
                        var g = e(d)[q] - w;
                    ...
                    l && (m = setTimeout(function() { l.parentNode.removeChild(l), l = null }, 100)), u = !1;
                    var a = 0;
            ...
            function d(a, b, c) {
                var d = .001,
                    ...
                    f = e * e / (2 * d),
                    g = 0;
                return Math.abs(f) > c && (f = c, e /= 6), f *= 0 > a ? -1 : 1, g = e / d, { dist: f, time: g }
            }
    ...
    Q.scatter = {
        ...
        init: function() {
            ...
            h(a, { display: "block", visibility: "hidden", left: 0, top: 0 });
            var b = q(),
            ...
            }), h(c, { position: "absolute" }), h(d(".-mob-share-ui-bg"), { display: "none" })
        },
        open: function() {
            var a = d(".-mob-share-ui"),
            ...
            if (c.length) {
                ...
                n += (m - f) / 2, k(c, function(a) {
                    var b = Math.floor(a / e) + 1,
                        c = 50 * b;
                    O(this, { top: (b - 1) * g + c + "px", left: a % e * m + n + "px" }, 300)
                })
            }
            h(a, { visibility: "inherit" }), O(a, { opacity: 1 }, 300, function() {
                h(b, {
                    height: function() {
        ...
        close: function() {
            ...
            O(a, { opacity: 0 }, 300, function() { h(a, { visibility: "hidden" }) }), O(b, {
                top: function() {
        ...
        init: function() {
            var a = d(".-mob-share-ui");
            h(a, { display: "block", visibility: "inherit" }), h(a, {
                bottom: function() {
                    return "-" + this.clientHeight + "px"
                }
            }), h(a, { visibility: "hidden" }), h(d(".-mob-share-ui-bg"), { display: "none" })
        },
        open: function() {
            var a = d(".-mob-share-ui");
            h(a, { visibility: "inherit" }), O(a, { bottom: "0px" }, 300);
            var b = d(".-mob-share-ui-bg");
            h(b, { opacity: 0, display: "block" }), O(b, { opacity: .5 }, 300)
        },
        close: function() {
            var a = d(".-mob-share-ui");
            O(a, {
            ...
            }, 300, function() { h(a, { visibility: "hidden" }) });
            var b = d(".-mob-share-ui-bg");
            O(b, { opacity: 0 }, 300, function() { h(b, { display: "none" }) })
        },
        resize: function() { this.init() }
    }, Q.slideLeft = {
        horizontal: !1,
        ...
        open: function() {
            var a = d(".-mob-share-ui");
            h(a, { visibility: "inherit" }), O(a, { left: "0px" }, 300);
            var b = d(".-mob-share-ui-bg");
            h(b, { opacity: 0, display: "block" }), O(b, { opacity: .5 }, 300)
        },
        close: function() {
        ...
        open: function() {
            var a = d(".-mob-share-ui");
            h(a, { visibility: "inherit" }), O(a, { right: "0px" }, 300);
            var b = d(".-mob-share-ui-bg");
            h(b, { opacity: 0, display: "block" }), O(b, { opacity: .5 }, 300)
        },
        close: function() {
        ...
        open: function() {
            var a = d(".-mob-share-ui");
            h(a, { visibility: "inherit" }), O(a, { top: "0px" }, 300);
            var b = d(".-mob-share-ui-bg");
            h(b, { opacity: 0, display: "block" }), O(b, { opacity: .5 }, 300)
        },
        close: function() {
        ...
        init: function() {
            var c = function() {
                ...
                for (var c in b) {
                    ...
                    j(f, "-mob-share-initialized"), g(f, "click", function() {
                        var a = c;
                        return function() { M(a).send(), M.ui.close() }
                    }())
                }
                ...
                if (h.length) {
                    ...
                    g(n, "click", function() { M.ui.open() });
                    var o = d(".-mob-share-close, .-mob-share-ui-bg");
                    g(o, "click", function() { M.ui.close() }), g(o, "mousemove touchmove", function(b) {
            ...
            if (R || null === M.getConfig("staticDir")) c();
                ...
                f.rel = "stylesheet", f.type = "text/css", f.href = M.getConfig("staticDir") + "/mob-share.css";
                var h = !1,
                    l = function() { h || (c(), h = !0) };
                s(f, l), f.onload = l, b.getElementsByTagName("head")[0].appendChild(f)
            }
        },
        open: function() { Q[S].open() },
        close: function() { Q[S].close() },
        resize: function() { Q[S].resize() }
    }, M.ready(function() { M.ui.init(), g(a, "resize", function() { M.ui.resize() }) }), a.mobShare = M, "function" == typeof a.define && (a.define.amd || a.define.cmd) && a.define("mob-share", [], function() {
        return M.ui.init(), M
    })
}(window, document);
